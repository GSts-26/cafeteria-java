...
//        Tabla_empleado.setDefaultRenderer(Object.class, new render());
    ...
    private void initComponents() {
        ...
        if (Tabla_empleado.getColumnModel().getColumnCount() > 0) {
            ...
            Tabla_empleado.getColumnModel().getColumn(3).setPreferredWidth(200);
            ...
            Tabla_empleado.getColumnModel().getColumn(5).setPreferredWidth(120);
            Tabla_empleado.getColumnModel().getColumn(6).setResizable(false);
            Tabla_empleado.getColumnModel().getColumn(6).setPreferredWidth(210);
            Tabla_empleado.getColumnModel().getColumn(7).setResizable(false);
            Tabla_empleado.getColumnModel().getColumn(7).setPreferredWidth(130);
